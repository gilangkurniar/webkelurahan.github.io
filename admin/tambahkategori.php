...
if (isset($_POST['tambahkat'])) {
    ...
    $hasil = mysqli_query($connect,"INSERT INTO kategori (kat,alias,terbit) VALUES ('".$_POST['kat']."','".$_POST['alias']."','".$_POST['terbit']."')");
      ...
      <form action="" method="POST">
        <div class="card mb-4 mt-4">
            ...
            <div class="card-body">
                ...
                <input class="form-control" type="text" placeholder="Kategori Baru" name="kat" id="kat" autocomplete="off" required></div>
              
                <div class="form-group">
                <label for="alias">Alias :</label>
                <input class="form-control" type="text" placeholder="Alias" name="alias" id="alias" autocomplete="off" required></div>
